...
export default function Home() {
  ...
  return <main>
    <nav className="nav shell">
      <a className="brand" href="#top"><span className="brand-mark"><Asterisk size={22}/></span>BOLD<span>LUME</span></a>
    ...
    <section className="work-preview shell" id="work">
      ...
      <div className="projects">
        <article className="project-card blue"><div className="project-copy"><span>Concept case study · SaaS platform</span><h3>OrbitOps</h3><p>A focused operations workspace that helps distributed teams plan, automate, and deliver without the clutter.</p><div className="project-tags"><b>Next.js</b><b>TypeScript</b><b>PostgreSQL</b></div><a href="https://github.com/wekan/wekan" target="_blank" rel="noreferrer">Explore the open-source base <ArrowUpRight size={16}/></a></div><div className="project-visual"><div className="browser"><div className="browser-bar">● &nbsp; orbitops / today</div><div className="browser-body"><aside>ORBITOPS<br/><b>My tasks</b><br/>Roadmap<br/>Team</aside><div><small>MONDAY, AUG 24</small><h4>Good morning, Alex.</h4><div className="fake-row">Launch onboarding flow <b>In review</b></div><div className="fake-row">Mobile navigation <b>In progress</b></div><div className="fake-row">QA release candidate <b>Ready</b></div></div></div></div></div></article>
    ...
    <footer className="footer shell"><a className="brand" href="#top"><span className="brand-mark"><Asterisk size={22}/></span>BOLD<span>LUME</span></a><p>© 2026 Boldlume. Bright ideas. Boldly built.</p><div><a href="mailto:business@boldlume.com">Email</a><a href="#work">Selected work</a><a href="#top">Back to top ↑</a></div></footer>
  </main>;
}
