...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero shell" id="top">
      ...
      <div className="hero-bottom"><p>Strategy, design, and engineering for ambitious teams. From a sharp first release to products used at scale.</p><a className="circle-link" href="#work" aria-label="See our work"><ArrowDown size={27}/></a></div>
    ...
    <section className="work-preview shell" id="work">
      ...
      <div className="projects">
        <article className="project-card blue"><div className="project-copy"><span>Open-source web platform · 2025</span><h3>OpenBoard</h3><p>A focused project workspace for teams that want clarity without the clutter.</p><a href="https://github.com/wekan/wekan" target="_blank" rel="noreferrer">Explore the open-source base <ArrowUpRight size={16}/></a></div><div className="project-visual"><div className="browser"><div className="browser-bar">● &nbsp; openboard / today</div><div className="browser-body"><aside>OPENBOARD<br/><b>My tasks</b><br/>Roadmap<br/>Team</aside><div><small>MONDAY, AUG 24</small><h4>Good morning, Alex.</h4><div className="fake-row">Launch onboarding flow <b>In review</b></div><div className="fake-row">Mobile navigation <b>In progress</b></div><div className="fake-row">QA release candidate <b>Ready</b></div></div></div></div></div></article>
      ...
      <p className="case-note">OpenBoard, PocketFlow, and Verdant are concept case studies. Their linked open-source foundations can be used to create practical initial client projects.</p>
    </section>
    ...
    <section className="contact" id="contact"><div className="shell"><span>Have a project in mind?</span><h2>Let’s make it<br/><em>matter.</em></h2><a href="mailto:hello@northstarlabs.dev">hello@northstarlabs.dev <ArrowUpRight/></a></div></section>
    <footer className="footer shell"><a className="brand" href="#top"><span className="brand-mark"><Asterisk size={22}/></span>NORTHSTAR<span>LABS</span></a><p>© 2026 Northstar Labs. Built with care.</p><div><a href="#">LinkedIn</a><a href="#">GitHub</a><a href="#top">Back to top ↑</a></div></footer>
  </main>;
}
